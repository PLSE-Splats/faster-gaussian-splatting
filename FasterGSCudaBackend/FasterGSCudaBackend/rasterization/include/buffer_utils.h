...
/**
 * Pack 2 ushorts into a 32-bit item (using a uint).
 */
...
/**
 * Extract the 4D screen bounds vector from the geometry record.
 */
__device__ __forceinline__ ushort4
unpack_screen_bounds_from_geometry(const float4 geometry_record) {
